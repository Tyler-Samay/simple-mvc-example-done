...
const router = (app) => {
  ...
  // When someone Posts to /setDog, call controllers.createNewDog
  app.post('/setDog', controllers.createNewDog);

  // When someone Posts to /ageDog, call controllers.ageDog
